...
from myresnet import resnet50_extra
...
class N_ResNet50(nn.Module):
    def __init__(self, fm_ids,pretrained = True):
        ...
        self.layers = resnet50_extra(pretrained = pretrained)
        self.fm_ids = fm_ids
...
# fm_ids = ['layer2','layer3' ,'layer4', 'layer5']
def get_resnet50_fms(fm_ids = ['layer2','layer3' ,'layer4', 'layer5'], pretrained=True):

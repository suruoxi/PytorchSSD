...
from .ResNet50 import get_resnet50_fms
...
class RefineDet(nn.Module):
    ...
    def __init__(self, num_classes, size, use_refine=True):
        ...
        self.extras = nn.Sequential(nn.Conv2d(2048, 256, kernel_size=1, stride=1, padding=0), nn.ReLU(inplace=True), \
        ...
        self.trans_layers = nn.ModuleList([nn.Sequential(nn.Conv2d(2048, 256, kernel_size=3, stride=1, padding=1),
                                                         nn.ReLU(inplace=True),
                                                         nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)), \
